...
?>
<br>
<h1>Загрузка банера для главной страницы. Размер 1230 х 785 px!</h1>
...
<div style="width: 50%">
    <div class="table_body">
		...
		<tr><form method=post>
			...
			<td>
			  <br><b>Расположение текста</b> : <br><input type="radio" name="text_place" data-id="0" value="text_inside" checked> Текст по центру :
												<br><input type="radio" name="text_place" data-id="0" value="text_bottom"> Текст под банером
 ...
 <tr id="<?php echo $value['baner_id']; ?>">
	  ...
	  <td>
		  <br><b>Расположение текста</b> :
			<br><input type="radio" id="text_place<?php echo $value['baner_id'];?>" name="text_place<?php echo $value['baner_id'];?>" class="brand edit" value="text_inside" <?php if($value['baner_place'] == 'text_inside') echo 'checked'; ?> > Текст по центру
			<br><input type="radio" id="text_place<?php echo $value['baner_id'];?>" name="text_place<?php echo $value['baner_id'];?>" class="brand edit" value="text_bottom" <?php if($value['baner_place'] == 'text_bottom') echo 'checked'; ?> > Текст под банером
...
<?php } ?>
  ...
  <script>
	...
	$(document).on('change','.edit', function(){
		...
		var place = $('#text_place'+id+':checked').val();
