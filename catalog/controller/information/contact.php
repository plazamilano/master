...
class ControllerInformationContact extends Controller {
	...
	public function index() {
		...
		$data['error_ordernumber'] = $this->language->get('error_ordernumber');
		$data['error_email'] = $this->language->get('error_email');
		$data['error_enquiry'] = $this->language->get('error_enquiry');
		$data['error_countries_country'] = $this->language->get('error_countries_country');

$data['text_for_contact'] = $this->language->get('text_for_contact');
$data['text_info'] = $this->language->get('text_info');
$data['text_contact_us'] = $this->language->get('text_contact_us');
$data['entry_lastname'] = $this->language->get('entry_lastname');
$data['error_form_name'] = $this->language->get('error_form_name');
$data['error_form_lastname'] = $this->language->get('error_form_lastname');
$data['error_form_email'] = $this->language->get('error_form_email');
$data['entry_ordernum'] = $this->language->get('entry_ordernum');
$data['error_form_ordernum'] = $this->language->get('error_form_ordernum');
$data['error_form_theme'] = $this->language->get('error_form_theme');
$data['entry_theme'] = $this->language->get('entry_theme');
$data['entry_message'] = $this->language->get('entry_message');
$data['error_form_message'] = $this->language->get('error_form_message');
$data['text_form_message_count'] = $this->language->get('text_form_message_count');
$data['entry_country'] = $this->language->get('entry_country');
$data['error_form_country'] = $this->language->get('error_form_country');
$data['entry_chose_country'] = $this->language->get('entry_chose_country');
...
$data[''] = $this->language->get('');
		...
		$data['contact_theme'] = $this->model_localisation_content->getContents('contact_theme');
		...
		if (isset($this->request->post['ordernumber'])) {
			$data['ordernumber'] = $this->request->post['ordernumber'];
		} else {
			$data['ordernumber'] = '';
		}
